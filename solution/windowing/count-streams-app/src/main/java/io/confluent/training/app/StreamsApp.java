...
public class StreamsApp {
    ...
    private static Topology getTopology() {
        ...
        // TO-DO: create a KStream from the clicks-topic topic
        ...
        // TO-DO: group by key the KStream "clicks"
        final KGroupedStream<String, ClicksProtos.Clicks> clicksGrouped = clicks.groupByKey();

        // TO-DO: apply a Session Window of 5 minutes with a Grace period of 30 seconds to the KGroupedStream "clicksGrouped"
        //        and apply a count to get the number of clicks per IP and per Session Window
        final KTable<Windowed<String>, Long> clicksCount = clicksGrouped
                .windowedBy(SessionWindows.with(Duration.ofMinutes(5)).grace(Duration.ofSeconds(30)))
                .count();

        // TO-DO: convert the KTable "clicksCount" into a KStream
        ...
        // TO-DO: produce the data of the KStream "clicksCountStreamModified" to the topic "window-streams" 
